...
character_test_sources = [
    ...
    "test/character/collision_geometry_test.cpp",
    "test/character/forward_kinematics_test.cpp",
    "test/character/joint_test.cpp",
    "test/character/joint_state_test.cpp",
...
character_solver_public_headers = [
    ...
    "character_solver/error_function_utils.h",
    ...
    "character_solver/skinned_locator_triangle_error_function.h",
...
character_sequence_solver_public_headers = [
    ...
    "character_sequence_solver/finite_difference_sequence_error_function.h",
    "character_sequence_solver/fwd.h",
    "character_sequence_solver/jerk_sequence_error_function.h",
    ...
    "character_sequence_solver/velocity_magnitude_sequence_error_function.h",
...
character_sequence_solver_sources = [
    ...
    "character_sequence_solver/finite_difference_sequence_error_function.cpp",
    "character_sequence_solver/jerk_sequence_error_function.cpp",
    ...
    "character_sequence_solver/velocity_magnitude_sequence_error_function.cpp",
